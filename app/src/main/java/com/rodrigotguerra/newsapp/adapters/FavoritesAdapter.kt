...
import com.rodrigotguerra.newsapp.views.FavoritesFragmentDirections
import com.rodrigotguerra.newsapp.views.NewsFragmentDirections

class FavoritesAdapter(private val newsList: ArrayList<NewsData>) :
    RecyclerView.Adapter<FavoritesAdapter.NewsViewHolder>(), NewsClickListener {
    ...
    override fun onNewsClicked(view: View, articleId: Int) {
        val action = FavoritesFragmentDirections.actionFavoritesFragmentToArticleDetailsFragment()
